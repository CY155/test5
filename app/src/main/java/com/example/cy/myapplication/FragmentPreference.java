...
public class FragmentPreference extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_preference);
        inview();
        setlistern();
    ...
    private void setlistern() {
        ...
        group1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                {
                    Toast.makeText(FragmentPreference.this,"选中第一个",Toast.LENGTH_SHORT).show();
                }
                if(i==R.id.radio_btn2)
                {
                    Toast.makeText(FragmentPreference.this,"选中第二个",Toast.LENGTH_SHORT).show();
                }
                if(i==R.id.radio_btn3)
                    Toast.makeText(FragmentPreference.this,"选中第三个",Toast.LENGTH_SHORT).show();
            }
        });
        linear_activity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FragmentPreference.this, Screenpreference.class));
            }
        });
    ...
    private void create_dialog_list() {
        ...
        AlertDialog.Builder builder=new AlertDialog.Builder(FragmentPreference.this);
    ...
    private void create_dialog_edit() {
        final EditText editText=new EditText(FragmentPreference.this);
        AlertDialog.Builder   editdialog=new AlertDialog.Builder(FragmentPreference.this);
        editdialog.setTitle("Pick your favourite animal");
        editdialog.setView(editText);
        editdialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(FragmentPreference.this,editText.getText().toString(),Toast.LENGTH_SHORT).show();
